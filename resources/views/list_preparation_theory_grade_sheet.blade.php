...
@endpush
<form id="form-list-of-prepare-theory-grade-sheet" action="{{ route('theory.grade.sheet.store') }}" method="POST">
    @csrf
                                    ...
                                    <section class="card card-featured card-featured-secondary">
                                        ...
                                        <div class="card-body card-list-of-prepare-theory-grade-sheet">
                                            <div class="form-group row pb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-select-append">
                                                        ...
                                                        <select class="form-control"
                                                                name="prepare_theory_grade_sheet_teacher_ids[{{ $single_course['id'] }}][]"
                                                                multiple="multiple"
                                                ...
                                                <div class="col-md-2">
                                                    <input
                                                        name="prepare_theory_grade_sheet_no_of_students[{{ $single_course['id'] }}]"
                                                        type="number" min="1"
