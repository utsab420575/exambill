                        ...
                        <ul class="nav nav-main">
                            ...
                            <li class="nav-parent {{ request()->routeIs('all_form') ? 'nav-expanded nav-active' : '' }}">
                                ...
                                <ul class="nav nav-children">
                                    <li class="{{ request()->routeIs('all_form') ? 'nav-active' : '' }}">
                                        <a class="nav-link"  href="{{ route('all_form', ['sid' => 49])}}">
                                            All Form
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <div class="sidebar-widget widget-friends">
                        ...
                        <ul>
                            <li class="status-online">
                                <figure class="profile-picture">
                                    <img src="{{asset('dashboard/img/!sample-user.jpg')}}" alt="Joseph Doe" class="rounded-circle">
                                </figure>
