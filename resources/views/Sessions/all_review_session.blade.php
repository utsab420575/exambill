            ...
            <div class="row">
                <div class="col">
                    <section class="card">
                        ...
                        <div class="card-body">
                            <form id="sessionReviewForm" class="form-horizontal form-bordered" method="get">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('sessionReviewForm');
        ...
        if (form && select) {
            form.addEventListener('submit', function (e) {
                ...
                if (selectedId) {
                    const routeBase = "{{ url('/sessions/review/form') }}";
