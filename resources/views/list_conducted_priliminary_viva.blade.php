...
@push('scripts')
    <script>
        ...
        function createTeacherRow() {
            ...
            <div class="col-md-6">
                <select name="conducted_preliminary_viva_teacher_ids[]" class="form-select teacher-select" data-row="${conductedPreliminaryVivaRowCount}" disabled required>
                    <option value="">-- Select Teacher --</option>
                    ${conductedPreliminaryVivaTeachers.map(t => `<option value="${t.id}">${t.user.name}, ${t.designation.name}</option>`).join('')}
                </select>
            </div>
            <div class="col-md-4">
