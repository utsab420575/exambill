...
@endpush
<form id="form-list-of-prepare-sessional-grade-sheet" action="{{ route('sessional.grade.sheet.store') }}" method="POST">
    @csrf
        ...
        <div class="col-md-12">
            <section class="card card-featured card-featured-primary">
                <header class="card-header">
                    <h2 class="card-title">List of Teachers for the Preparation of Grade Sheet(Sessional) (@35/- per student per subject):
                    </h2>
                </header>
