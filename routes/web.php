...
Route::get('/check', [App\Http\Controllers\HomeController::class, 'check'])->name('check')->middleware(['roles:user']);
Route::get('/regular-previous-sessions',[\App\Http\Controllers\StaffController::class,'regular_previous_sessions']);
Route::get('/review-previous-sessions',[\App\Http\Controllers\StaffController::class,'review_previous_sessions']);
Route::get('/session-wise-theory-courses/{sid}',[\App\Http\Controllers\StaffController::class,'session_wise_theory_courses']);
Route::get('/all-form/{sid}',[\App\Http\Controllers\StaffController::class,'all_form'])->name('all_form');
...
Route::get('/session-wise-sessional-courses/{sid}',[\App\Http\Controllers\StaffController::class,'session_wise_sessional_courses']);
...
Route::post('/conducted/oral/exam/store', [StaffController::class, 'storeConductedOralExam'])->name('conducted.oral.exam.store');
